...
public class Principal {
	...
	public static void main(String[] args) {
		...
		int valor, num, numT, numM, numPartidos;
		...
		do {
			...
			switch(valor) {
				...
				case 2:
					...
					do {
						...
						switch(num) {
							...
							default:
								System.out.println("Recuerda que entre los dos solo tenemos 20 dedos...\n");
								break;
						}
					}while(num != 0);
					break;
				...
				default:
					System.out.println("Si no quieres jugar me lo dices desde el rpincipio, pero no me mientas :_(");
					break;
